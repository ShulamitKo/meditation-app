...
9. **אורך מחייב**: כ-${request.duration * 140} מילים של טקסט מדובר (לא כולל את סימני ההפסקה) - זה מה שממלא ${request.duration} דקות קריאה כשההפסקות מדודות כמו שהוסבר למעלה. אם משתמשים בהפסקה אחרי כל משפט כמו פעם, האורך בפועל יוצא כפול ומעלה מהמבוקש - לכן חשוב לשמור על מספר ההפסקות המצומצם שצוין
