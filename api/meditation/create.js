...
9. **אורך מחייב**: כ-${request.duration * 80} מילים של טקסט מדובר בלבד (נמדד בפועל מול הקול המוקלט - כ-80 מילים לדקה, קצב איטי ומודגש כמו שמדיטציה מוקלטת נשמעת). אל תכתבי יותר ממספר המילים הזה - טקסט ארוך מדי יוצא הרבה מעבר למשך המבוקש
